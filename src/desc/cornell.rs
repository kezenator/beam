...
{
    let wall_rect = |point: Point3, u: Point3, v: Point3, color: RGBA| -> Object
    {
        Object::new(
    ...
    let white_box = |min: Point3, max: Point3| -> Object
    {
        Object::new(
            Aabb::new(min, max),
            Material::diffuse(Texture::solid(RGBA::new(1.0, 1.0, 1.0, 1.0))))
    };
    ...
    Scene::new(
        ...
        vec![
            ...
            wall_rect(Point3::new(0.0, 0.0, 0.0), Point3::new(0.0, 555.0, 0.0), Point3::new(0.0, 0.0, 555.0), RGBA::new(1.0, 0.0, 0.0, 1.0)),
            wall_rect(Point3::new(555.0, 0.0, 0.0), Point3::new(0.0, 555.0, 0.0), Point3::new(0.0, 0.0, 555.0), RGBA::new(0.0, 1.0, 0.0, 1.0)),
            wall_rect(Point3::new(0.0, 555.0, 0.0), Point3::new(555.0, 0.0, 0.0), Point3::new(0.0, 0.0, 555.0), RGBA::new(1.0, 1.0, 1.0, 1.0)),
            wall_rect(Point3::new(0.0, 0.0, 0.0), Point3::new(555.0, 0.0, 0.0), Point3::new(0.0, 555.0, 0.0), RGBA::new(1.0, 1.0, 1.0, 1.0)),
            wall_rect(Point3::new(0.0, 0.0, 0.0), Point3::new(555.0, 0.0, 0.0), Point3::new(0.0, 0.0, 555.0), RGBA::new(1.0, 1.0, 1.0, 1.0)),
